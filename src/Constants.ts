  ...
  sections: [
    {
      ...
      rows: [
        ...
        [
          ...
          { type: 'common', label: 'Backspace', code: 'Backspace', width: 2, unicode: '⌫' },
        ],
        [
        ...
        [
          { type: 'common', label: 'Caps', code: 'CapsLock', width: 1.75, unicode: '⇪' },
        ...
        [
          { type: 'common', label: 'Shift', code: 'ShiftLeft', width: 2.25, unicode: '⇧' },
          ...
          { type: 'common', label: 'Shift', code: 'ShiftRight', width: 2.75, unicode: '⇧' },
        ],
        [
          {
            type: 'os-specific',
            width: 1.5,
            os: {
              macos: { label: 'Control', code: 'ControlLeft', unicode: '⌃', modifier: 'Control' },
              windows: { label: 'Ctrl', code: 'ControlLeft', unicode: 'Ctrl', modifier: 'Control' },
              linux: { label: 'Ctrl', code: 'ControlLeft', unicode: 'Ctrl', modifier: 'Control' },
            },
          },
          {
            type: 'os-specific',
            width: 1.5,
            os: {
              macos: { label: 'Alt', code: 'AltLeft', unicode: '⌥', modifier: 'Alt' },
              windows: { label: 'Win', code: 'MetaLeft', unicode: 'Win', modifier: undefined },
              linux: { label: 'Win', code: 'MetaLeft', unicode: 'Super', modifier: undefined },
            },
          },
          {
            type: 'os-specific',
            width: 1.5,
            os: {
              macos: { label: 'Meta', code: 'MetaLeft', unicode: '⌘', modifier: 'Meta' },
              windows: { label: 'Alt', code: 'AltLeft', unicode: 'Alt', modifier: 'Alt' },
              linux: { label: 'Alt', code: 'AltLeft', unicode: 'Alt', modifier: 'Alt' },
            },
          },
          { type: 'common', label: ' ', code: 'Space', unicode: '⎵', width: 6 },
          {
            ...
            width: 1.5,
            os: {
              macos: { label: 'Meta', code: 'MetaRight', unicode: '⌘', modifier: 'Meta' },
              windows: { label: 'Alt', code: 'AltRight', unicode: 'Alt', modifier: 'Alt' },
              linux: { label: 'Alt', code: 'AltRight', unicode: 'Alt', modifier: 'Alt' },
            },
          },
          {
            type: 'os-specific',
            width: 1.5,
            os: {
              macos: { label: 'Alt', code: 'AltRight', unicode: '⌥', modifier: 'Alt' },
              windows: { label: 'Win', code: 'MetaRight', unicode: 'Win', modifier: undefined },
              linux: { label: 'Win', code: 'MetaRight', unicode: 'Super', modifier: undefined },
            },
          },
          {
            type: 'os-specific',
            width: 1.5,
            os: {
              macos: { label: 'Control', code: 'ControlRight', unicode: '⌃', modifier: 'Control' },
              windows: { label: 'Ctrl', code: 'ControlRight', unicode: 'Ctrl', modifier: 'Control' },
              linux: { label: 'Ctrl', code: 'ControlRight', unicode: 'Ctrl', modifier: 'Control' },
            },
          },
        ],
      ],
    },
    {
      ...
      rows: [
        ...
        [
          { type: 'common', label: 'ArrowLeft', code: 'ArrowLeft', unicode: '←' },
          { type: 'common', label: 'ArrowDown', code: 'ArrowDown', unicode: '↓' },
          { type: 'common', label: 'ArrowRight', code: 'ArrowRight', unicode: '→' },
        ],
      ],
    },
    {
